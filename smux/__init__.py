...
""".format(dtach_socket).encode()
    ...
    def get_attach_command(self, name):
        ...
        return "dtach -A {0} bash".format(socket)
...
class Smux():
    ...
    def main(cls):
        ...
        new.add_argument('--nodes',type=int, default=[defaults.get('nodes')], metavar="<n>",nargs=1,help="The number of nodes you need")
        new.add_argument('--mem', default=[defaults.get('mem')], metavar="<n>",nargs=1,help="The amount of memory you need")
        new.add_argument('--cpuspertask',type=int, default=[defaults.get('cpuspertask')], metavar="<n>",nargs=1,help="The number of cpus needed for each task")
        ...
        new.add_argument('-A','--account', default=[defaults.get('account')], metavar="<n>",nargs=1,help="Specify your account")
        new.add_argument('-p','--partition',default=[defaults.get('partition')],nargs=1,help="The partition to execute on")
        new.add_argument('-r','--reservation',default=[defaults.get('reservation')],nargs=1,help="The reservation to use")
        new.add_argument('-t','--time',default=[defaults.get('time')],nargs=1,help="The amount of time to run for")
        new.add_argument('--gres',default=[defaults.get('gres')], metavar="<n>",nargs=1,help="The type and number of gpus needed for each task")
