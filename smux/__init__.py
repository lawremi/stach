...
"""
    ...
    def main(cls):
        ...
        new.add_argument('-J','--jobname', default=["interactive_session"], metavar="<n>",nargs=1,help="Give a name for you job")
        new.add_argument('-J','--account', default=["interactive_session"], metavar="<n>",nargs=1,help="Specifi your account")
